...
# Unit tests for MfkOpenapiRubyClient::DestinationApi
...
describe 'DestinationApi' do
  ...
  describe 'test an instance of DestinationApi' do
    it 'should create an instance of DestinationApi' do
      expect(@api_instance).to be_instance_of(MfkOpenapiRubyClient::DestinationApi)
    end
  end
  ...
  # @option opts [Time] :created_at_from 指定された日時以降に作成された請求先を取得します。指定された日時に作成されたものも含まれます。 RFC3339の&#x60;date-time&#x60;(2019-04-01T10:36:43%2B09:00)で指定してください。
  # @option opts [Time] :created_at_to 指定された日時以前に作成された請求先を取得します。指定された日時に作成されたものも含まれます。 RFC3339の&#x60;date-time&#x60;(2019-04-01T10:36:43%2B09:00)で指定してください。
