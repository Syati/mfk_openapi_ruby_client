...
# Unit tests for MfkOpenapiRubyClient::Transaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MfkOpenapiRubyClient::Transaction do
  let(:instance) { MfkOpenapiRubyClient::Transaction.new }

  describe 'test an instance of Transaction' do
    it 'should create an instance of Transaction' do
      expect(instance).to be_instance_of(MfkOpenapiRubyClient::Transaction)
    end
  end
  ...
  describe 'test attribute "billing_accepted_at"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
