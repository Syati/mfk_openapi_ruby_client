...
# Unit tests for MfkOpenapiRubyClient::CustomerExaminationPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MfkOpenapiRubyClient::CustomerExaminationPayload do
  let(:instance) { MfkOpenapiRubyClient::CustomerExaminationPayload.new }

  describe 'test an instance of CustomerExaminationPayload' do
    it 'should create an instance of CustomerExaminationPayload' do
      expect(instance).to be_instance_of(MfkOpenapiRubyClient::CustomerExaminationPayload)
    end
  end
