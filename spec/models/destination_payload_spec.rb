...
# Unit tests for MfkOpenapiRubyClient::DestinationPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MfkOpenapiRubyClient::DestinationPayload do
  let(:instance) { MfkOpenapiRubyClient::DestinationPayload.new }

  describe 'test an instance of DestinationPayload' do
    it 'should create an instance of DestinationPayload' do
      expect(instance).to be_instance_of(MfkOpenapiRubyClient::DestinationPayload)
    end
  end
