...
# Unit tests for MfkOpenapiRubyClient::Destination
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe MfkOpenapiRubyClient::Destination do
  let(:instance) { MfkOpenapiRubyClient::Destination.new }

  describe 'test an instance of Destination' do
    it 'should create an instance of Destination' do
      expect(instance).to be_instance_of(MfkOpenapiRubyClient::Destination)
    end
  end
